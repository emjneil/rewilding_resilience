...
def check_resilience():
    ...
    for i in range(200):
        for i in stocking_changes:
            ...
            initial_veg = [initial_wood, initial_grass, initial_veg]

            print("first", initial_veg)
            ...
            print("now", initial_wood, initial_grass,initial_scrub )
            ...
            model = KneppModel(initial_roe, roe_deer_reproduce, roe_deer_gain_from_saplings, roe_deer_gain_from_trees, roe_deer_gain_from_scrub, roe_deer_gain_from_young_scrub, roe_deer_gain_from_grass,
                                ...
                                max_time = 185, reintroduction = True, introduce_euroBison = False, introduce_elk = False)
