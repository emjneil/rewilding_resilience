    ...
    def step(self):
        ...
        if self.reintroduction == True:
            ...
            if self.schedule.time >= 193 and ((self.schedule.time % 12) + 1) == 3:
                ...
                if (abs(results.iloc[-1]["Grassland"]-results.iloc[five_years_ago]["Grassland"]) < 3) and (abs(results.iloc[-1]["Thorny Scrub"]-results.iloc[five_years_ago]["Thorny Scrub"]) < 3) and (abs(results.iloc[-1]["Woodland"]-results.iloc[five_years_ago]["Woodland"]) < 3) and (abs(results.iloc[-1]["Roe deer"]-results.iloc[five_years_ago]["Roe deer"]) < 3):                
