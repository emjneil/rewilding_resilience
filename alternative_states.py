...
def space_sensitivity():
    ...
    # pick a few starting conditions - we want the first run to be initial conditions
    stocking_changes = [0, 1, 2, 3, 5, 10, 25, 50, 75, 100]
    ...
    # forecasting.to_csv("resilience_landscape_10runs_normal_space.csv")
    forecasting.to_csv("resilience_landscape_10runs_new_space.csv")
