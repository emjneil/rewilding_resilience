...
# now do it for all 100 accepted params, under current conditions
...
def all_params():
    ...
    # save to csv
    forecasting.to_csv("resilience_landscape_eem_allParams.csv")
    all_timeseries.to_csv("timeseries_eem_allParams.csv")
